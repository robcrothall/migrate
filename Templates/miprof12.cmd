 ...
 Arguments:     These are in the form KEYWORD=...  KEYWORD2=...
   ...
   INDENT=5        The number of spaces to indent on wrapped lines.

   LINELEN=60      Line length at which words will be wrapped.
...
If Debug = Yes then call SysSleep 1;
trace o;
/*------------- Main processing ------------------------------*/
        ...
        If left(work, 1) = '&' then do;
          ...
          Select;
            When Keyword = '&SECTION' then do;
              ...
              If Debug = Yes then In.L = Driver.vstring ':' In.L;
            End;
            Otherwise;
              Nop;
          End;
